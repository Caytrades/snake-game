...
window.alert("NOTE: You may not be able to use the (esc) or the (space) keys to quit or pause the game if you are running this game in a mobile phone or a tablet, so it's recommended that you record your points before quiting the game.");
  ...
  var game = {
	...
	loop: function () {
	  ...
	  if(!stopped) {
		...
		ctx.fobt = "10px Arial";
		ctx.fillText("Made with love from Cay", 33, 485);
	  }
